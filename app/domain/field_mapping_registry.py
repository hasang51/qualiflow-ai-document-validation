...
CANONICAL_FIELDS: dict[str, CanonicalFieldDefinition] = {
    ...
    "order_date": CanonicalFieldDefinition(
        canonical_name="order_date",
        description="Purchase order or customer order date.",
        business_meaning="Commercial order/PO date, independent of the certificate issue date.",
        category="metadata",
        value_type="date",
        units=None,
        examples=("25/06/2024", "2024-06-25"),
        supported_header_synonyms=(
            "ORDER DATE",
            "PO DATE",
            "P.O. DATE",
    ...
    "product_details": CanonicalFieldDefinition(
        canonical_name="product_details",
        description="Package, size, or other product-detail remainder text.",
        business_meaning="Secondary product/package description that must not overwrite product identity.",
        category="row",
        value_type="string",
        units=None,
        examples=("DIAM 0.80 mm", "15 kg spool"),
        supported_header_synonyms=(
            "PRODUCT DETAILS",
            "PACKAGE",
            "PACKAGING",
    ...
    "standards": CanonicalFieldDefinition(
        ...
        description="Visible standard or specification labels.",
        business_meaning="Published standard/spec lines printed on the certificate, distinct from classification codes.",
        category="row",
        value_type="string",
        units=None,
        examples=("EN ISO 14341-A", "AWS A5.18"),
        supported_header_synonyms=(
            "STANDARD",
            "STANDARDS",
            "NORMATIVE STANDARD",
    ...
    "classifications": CanonicalFieldDefinition(
        canonical_name="classifications",
        description="Visible AWS/EN/ISO/ASTM classification codes.",
        business_meaning="First-class classification values; never forced into grade or product_name.",
        category="row",
        value_type="string",
        units=None,
        examples=("ER70S-6", "M21", "C1"),
        supported_header_synonyms=(
            "CLASSIFICATION",
            "CLASSIFICATIONS",
            "CLASSIFICAZIONE",
...
# Labeled header identity fields kept independent during extraction/mapping.
IDENTITY_HEADER_FIELDS: tuple[str, ...] = (
    "certificate_number",
    "certificate_date",
    "order_number",
    "order_date",
...
IDENTIFIER_HEADER_FIELDS: tuple[str, ...] = (
    "certificate_number",
    "order_number",
    "heat_number",
    "batch_number",
...
def is_identity_header_field(field_name: str) -> bool:
    return field_name in IDENTITY_HEADER_FIELDS


def is_identifier_header_field(field_name: str) -> bool:
    return field_name in IDENTIFIER_HEADER_FIELDS
